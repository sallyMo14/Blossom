...
class LoginNewUserScreen extends StatefulWidget {
  const LoginNewUserScreen({Key? key}) : super(key: key);

  @override
  State<LoginNewUserScreen> createState() => _LoginNewUserScreenState();
}

class _LoginNewUserScreenState extends State<LoginNewUserScreen> {
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                TextButton(
                    onPressed: (){
                      Navigator.pushNamed(context, '/creat_new_account_screen');
                    }
